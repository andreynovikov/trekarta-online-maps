...
{
	private static final String MAPS_URI = "http://%s.tile.thunderforest.com/%s/%d/%d/%d.png";
	private static final String[] maps = {"cycle", "landscape", "transport", "outdoors"};

	private UriMatcher uriMatcher;
	private final String[] servers = {"a", "b", "c"};
	...
	private Cursor queryTiles(@NonNull Uri uri, String[] projection) {
		...
		String url = String.format(MAPS_URI, servers[nextServer], mapId, z, x, y);
		row.add(url);
