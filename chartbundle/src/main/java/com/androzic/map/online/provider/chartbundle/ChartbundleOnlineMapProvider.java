...
package com.androzic.map.online.provider.chartbundle;
...
{
	public static final String AUTHORITY = "com.androzic.map.online.provider.chartbundle";
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
	{
		...
		String url = String.format("http://wms.chartbundle.com/tms/1.0.0/%s/%d/%d/%d.png?type=google", path, z, x, y);
		row.add(url);
