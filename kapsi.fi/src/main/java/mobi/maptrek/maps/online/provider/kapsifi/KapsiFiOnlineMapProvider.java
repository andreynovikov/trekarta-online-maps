...
public class KapsiFiOnlineMapProvider extends ContentProvider {
    public static final String AUTHORITY = "mobi.maptrek.maps.online.provider.kapsifi";
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        String url = String.format("http://tiles.kartat.kapsi.fi/%s/%d/%d/%d.jpg", path, z, x, y);
        row.add(url);
